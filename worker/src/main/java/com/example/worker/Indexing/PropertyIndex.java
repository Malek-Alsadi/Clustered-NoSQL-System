...
public class PropertyIndex {
    ...
    public void add(String Property, String value, int idx){
    ...
    public List<Integer> getByProperty(String Property , String value){
        if(map.containsKey(Property) && map.get(Property).containsKey(value))
            return map.get(Property).get(value);
        else
            return new ArrayList<Integer>();
    }

    public HashMap<String, List<Integer>> getMap(String Property) {
